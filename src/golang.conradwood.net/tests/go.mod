...
require (
	...
	golang.conradwood.net/apis/auth v1.1.3462
	golang.conradwood.net/apis/common v1.1.3462
	...
	golang.conradwood.net/apis/goeasyops v1.1.3340
	golang.conradwood.net/apis/helloworld v1.1.3227
	golang.conradwood.net/apis/registry v1.1.3462
...
require (
	...
	golang.conradwood.net/apis/autodeployer v1.1.3462 // indirect
	golang.conradwood.net/apis/certmanager v1.1.3340 // indirect
	golang.conradwood.net/apis/deploymonkey v1.1.3462 // indirect
	golang.conradwood.net/apis/errorlogger v1.1.3340 // indirect
	golang.conradwood.net/apis/framework v1.1.3462 // indirect
	golang.conradwood.net/apis/grafanadata v1.1.3462 // indirect
	golang.conradwood.net/apis/h2gproxy v1.1.3340 // indirect
	golang.conradwood.net/apis/objectstore v1.1.3462 // indirect
	golang.org/x/net v0.30.0 // indirect
	golang.org/x/sys v0.27.0 // indirect
	golang.org/x/text v0.20.0 // indirect
	golang.yacloud.eu/apis/autodeployer2 v1.1.3340 // indirect
	golang.yacloud.eu/apis/faultindicator v1.1.3462 // indirect
	golang.yacloud.eu/apis/fscache v1.1.3462 // indirect
	golang.yacloud.eu/apis/session v1.1.3462 // indirect
	golang.yacloud.eu/apis/unixipc v1.1.3462 // indirect
