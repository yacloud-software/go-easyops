...
require (
	...
	golang.conradwood.net/apis/echoservice v1.1.1861
	golang.conradwood.net/apis/getestservice v1.1.1861
	golang.conradwood.net/apis/gitserver v1.1.1861
	golang.conradwood.net/apis/goeasyops v1.1.1861
	golang.conradwood.net/apis/registry v1.1.1861
	golang.conradwood.net/apis/rpcinterceptor v1.1.1861
