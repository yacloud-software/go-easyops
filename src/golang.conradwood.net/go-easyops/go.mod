...
require (
	...
	golang.yacloud.eu/apis/autodeployer2 v1.1.3625
	golang.yacloud.eu/apis/faultindicator v1.1.3625
	golang.yacloud.eu/apis/fscache v1.1.3625
	golang.yacloud.eu/apis/session v1.1.3659
	golang.yacloud.eu/apis/unixipc v1.1.3625
	golang.yacloud.eu/apis/urlcacher v1.1.3625
