...
require (
	...
	golang.conradwood.net/apis/errorlogger v1.1.2027
	golang.conradwood.net/apis/framework v1.1.2027
	golang.conradwood.net/apis/logservice v1.1.2027
	golang.conradwood.net/apis/objectstore v1.1.2027
	golang.conradwood.net/apis/registry v1.1.2027
	golang.conradwood.net/apis/rpcinterceptor v1.1.2027
	golang.org/x/net v0.4.0
	golang.org/x/sys v0.3.0
	golang.yacloud.eu/apis/urlcacher v1.1.2027
